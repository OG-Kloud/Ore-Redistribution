...
//WorldGenMinable
public class KGenMinable extends WorldGenerator{
...
//	private final IBlockState oreBlock;
	...
	protected KGenMinable(Vein vein) {
		this(vein, new KGenMinable.StonePredicate());
	}

	protected KGenMinable(Vein vein, Predicate<IBlockState> p_i45631_3_) {
		this.vein = vein;
		this.numberOfBlocks = vein.getVeinSize();
		this.predicate = p_i45631_3_;
		this.weight = vein.getVeinWeight();
	}
	...
	public boolean generate(World worldIn, Random rand, BlockPos position) {
		...
		for (int i = 0; i < this.numberOfBlocks; ++i) {
			IBlockState oreBlock = vein.oreByWeight();
