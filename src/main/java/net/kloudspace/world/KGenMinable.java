...
//	private final IBlockState oreBlock;
	...
	public KGenMinable(Vein vein, int genWeight) {
		this(vein, new KGenMinable.StonePredicate(), genWeight);
	}

	public KGenMinable(Vein vein, Predicate<IBlockState> p_i45631_3_, int genWeight) {
		this.vein = vein;
		this.numberOfBlocks = vein.getVeinSize();
		this.predicate = p_i45631_3_;
		this.weight = genWeight;
	}
